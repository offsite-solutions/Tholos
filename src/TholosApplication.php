<?php /** @noinspection DuplicatedCode SpellCheckingInspection PhpUnusedFunctionInspection NotOptimalIfConditionsInspection */
  ...
  */
  ...
  class TholosApplication {
    ...
    /**
     * @var number ID of the TApplication component (mandatory)
     * @see TApplication
     */
    ...
    /**
     * @var number ID of the current TRoute component being processed. Component's name is received in tholos_route parameter. (mandatory)
     */
    public $route_id;
     ...
     * @var array
     */
    public $BoolFalse = array();
    /**
     * @var array
     */
    public $BoolTrue = array();
    ...
    public function __construct() {
      ...
      try {
        ...
        if ($this->findComponentIDByTypeFromIndex('TRoleManager', $this->application_id)) {                                                // Instantiating TRoleManager if exists
          $this->roleManager = $this->instantiateComponent($this->findComponentIDByTypeFromIndex('TRoleManager', $this->application_id));
     ...
     * @return TComponent The instantiated object
     * @throws Throwable
     * @see TAction
     */
     ...
     * @return string TAction component's ID
     * @throws Throwable when no action is found
     */
    private function getActionId(string $rootType) {
     ...
     * @return TComponent Component object
     */
     ...
     */
    protected function findComponentId(TComponent $component_) {
     ...
     * @return bool|string Matching component's ID or `false` when no match found
     */
    private function findComponentIDByTypeFromIndex(string $componentType_, $parentId_ = NULL) {
      foreach ($this->componentIndex as $_component) {
        if (explode('.', $this->componentTypeIndex[$_component['p']]['h'])[0] === $componentType_) {
