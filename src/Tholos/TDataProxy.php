<?php /** @noinspection DuplicatedCode SpellCheckingInspection PhpUnusedFunctionInspection NotOptimalIfConditionsInspection */
  ...
  class TDataProxy extends TComponent {
     ...
     * @throws Exception
     */
    public function open(?TComponent $sender, array $requestPropertyNames_ = array(), array $responsePropertyNames_ = array()): array|string {
      ...
      try {
        ...
        return match ($header['response_code']) {
          200 => $result,
          default => [],
        };
